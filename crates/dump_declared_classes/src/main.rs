...
fn get_cli_params() -> CliParams {
    ...
    let file_path = matches.get_one::<String>("file_path").expect("Failed parsing file_path");
    ...
    let chain_id = matches.get_one::<String>("chain_id").expect("Failed parsing chain_id");
    CliParams {
        start_block,
        end_block,
