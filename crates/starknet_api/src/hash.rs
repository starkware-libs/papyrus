...
impl StarkHash {
    ...
    pub fn serialize(&self, res: &mut impl std::io::Write) -> Result<(), Error> {
        ...
        // The index of the byte with the first non-zero nibble (msb to lsb). Since the chooser
        // occupies a nibble, we shift one nibble left.
        ...
        let chooser = if first_index < 15 {
            ...
            // For up to 27 nibble felts: serialize the lower 4 + (chooser * 8) bits of the felt
