...
pub use self::transaction::{
    ...
    EntryPointType, EthAddress, Event, EventData, EventKey, Fee, InvokeTransaction,
    InvokeTransactionOutput, L1ToL2Payload, L2ToL1Payload, MessageToL1, MessageToL2, Program,
