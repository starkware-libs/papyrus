...
pub fn get_transaction_hash(
    ...
    match transaction {
        ...
        Transaction::Deploy(deploy) => get_deploy_transaction_hash_variant_1(deploy, chain_id),
...
pub fn validate_transaction_hash(
    ...
    let deprecated_hashes = match transaction {
        ...
        Transaction::Deploy(deploy) => {
            vec![get_deploy_transaction_hash_variant_0(deploy, chain_id)?]
        }
...
fn get_deploy_transaction_hash_variant_1(
...
fn get_deploy_transaction_hash_variant_0(
    transaction: &DeployTransaction,
    chain_id: &ChainId,
) -> Result<StarkHash, StarknetApiError> {
