...
/// From this block number onwards, the transaction hash can be directly determined
/// based on the transaction version.
const TRANSACTION_HASH_WITH_VERSION: BlockNumber = BlockNumber(1470);
...
pub fn validate_transaction_hash(
    ...
    // based on the transaction version.
    if chain_id.0 != *"SN_MAIN" || block_number < &TRANSACTION_HASH_WITH_VERSION {
