...
async fn pending_sync_classes_request_only_new_classes() {
    ...
    expected_pending_classes.add_class(first_class_hash, first_class.clone().into());
    expected_pending_classes.add_class(second_class_hash, second_class.clone().into());
