...
use crate::streamed_data_protocol::{self, Config, InboundSessionId, OutboundSessionId, SessionId};
    ...
    DBExecutor: db_executor::DBExecutor,
{
    ...
    pub fn new(config: Config, db_executor: Arc<DBExecutor>) -> Self {
        Self {
            inner_behaviour: streamed_data_protocol::behaviour::Behaviour::new(config),
