...
impl From<ResourceBoundsMapping> for protobuf::ResourceBounds {
    fn from(value: ResourceBoundsMapping) -> Self {
        ...
        let (_, resource_bounds_l1) = value
            .0
            .get_key_value(&Resource::L1Gas)
            .unwrap_or((&Resource::L1Gas, &resource_bounds_default));
        ...
        let resource_bounds_default = ResourceBounds::default();
        let (_, resource_bounds_l2) = value
            .0
            .get_key_value(&Resource::L2Gas)
            .unwrap_or((&Resource::L2Gas, &resource_bounds_default));
