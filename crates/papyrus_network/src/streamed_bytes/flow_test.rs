...
use super::behaviour::{Behaviour, Event, ExternalEvent, FromOtherBehaviour, ToOtherBehaviour};
...
fn assign_peer_to_outbound_session(
    ...
    outbound_swarm.behaviour_mut().on_other_behaviour_event(
        mixed_behaviour::InternalEvent::NotifyStreamedBytes(FromOtherBehaviour::SessionAssigned {
            outbound_session_id,
...
fn check_request_peer_assignment_event_and_return_session_id(
    ...
    let Event::ToOtherBehaviour(ToOtherBehaviour::NotifyPeerManager(
