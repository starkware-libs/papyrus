...
pub fn split_thin_state_diff(thin_state_diff: ThinStateDiff) -> Vec<StateDiffChunk> {
    ...
    contract_addresses.extend(thin_state_diff.deployed_contracts.keys());
    contract_addresses.extend(thin_state_diff.replaced_classes.keys());
    contract_addresses.extend(thin_state_diff.nonces.keys());
    contract_addresses.extend(thin_state_diff.storage_diffs.keys());
