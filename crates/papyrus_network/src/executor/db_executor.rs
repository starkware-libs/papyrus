...
impl<'a> DbExecutor<'a> {
    ...
    fn poll_for_new_queries(&mut self, cx: &mut Context<'_>, new_status: &mut DbExecutorStatus) {
    ...
    fn poll_for_new_data(
        mut self: Pin<&mut Self>,
        cx: &mut Context<'_>,
        mut new_status: DbExecutorStatus,
    ) -> Poll<Option<DbExecutorStatus>> {
