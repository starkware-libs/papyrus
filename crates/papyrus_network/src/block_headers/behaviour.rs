    ...
    DBExecutor: db_executor::DBExecutor,
{
    ...
    inner_behaviour: streamed_data::behaviour::Behaviour<
...
pub(crate) trait BehaviourTrait {
    fn map_inner_behaviour_event_to_own_event(
        &mut self,
        in_event: streamed_data::behaviour::Event<
            protobuf::BlockHeadersRequest,
            protobuf::BlockHeadersResponse,
        >,
    ...
    DBExecutor: db_executor::DBExecutor,
{
    ...
    pub fn new(config: Config, db_executor: Arc<DBExecutor>) -> Self {
        Self {
            inner_behaviour: streamed_data::behaviour::Behaviour::new(config),
    ...
    DBExecutor: db_executor::DBExecutor,
{
    fn map_inner_behaviour_event_to_own_event(
        ...
        match in_event {
            ...
            streamed_data::behaviour::Event::SessionFailed { session_id, error } => {
                Event::SessionFailed {
                    session_id,
            ...
            streamed_data::behaviour::Event::ReceivedData { data, outbound_session_id } => self
