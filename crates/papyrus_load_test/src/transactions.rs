...
pub fn block_number() -> Transaction {
    transaction_with_constant_request("blockNumber").set_name("block_number")
}

pub fn block_hash_and_number() -> Transaction {
    transaction_with_constant_request("blockHashAndNumber").set_name("block_hash_and_number")
}

pub fn chain_id() -> Transaction {
    transaction_with_constant_request("chainId").set_name("chain_id")
}

fn transaction_with_constant_request(method_name: &str) -> Transaction {
