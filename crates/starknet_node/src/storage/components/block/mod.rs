...
use starknet_api::{
    BlockHash, BlockHeader, BlockNumber, ClassHash, ContractAddress, IndexedDeployedContract,
    StarkFelt, StateDiffForward, StorageKey, Transaction, TransactionHash,
...
pub struct Tables {
    ...
    contract_classes: TableIdentifier<ClassHash, Vec<u8>>,
