...
pub use self::state::{StateDiffWithNoClassDefinitions, StateStorageReader, StateStorageWriter};
...
pub struct Tables {
    ...
    state_diffs: TableIdentifier<BlockNumber, StateDiffWithNoClassDefinitions>,
