...
use starknet_api::{BlockNumber, ClassHash, ContractAddress, StarkHash};
...
async fn main() {
    ...
    let _contract_class_by_address = starknet_client
        .class_by_address(ContractAddress(StarkHash(
