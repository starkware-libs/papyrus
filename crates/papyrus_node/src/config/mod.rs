...
impl Default for ConfigBuilder {
    fn default() -> Self {
        ...
        // TODO: set default values to other builders.
    }
}

impl ConfigBuilder {
    /// Set chain_id to all of the relevant configuration builders.
    fn chain_id(&mut self, chain_id: ChainId) {
        self.gateway.chain_id = chain_id;
    }

    // Parse a yaml config file and update the relevant config builders.
    // Absence of a parameter means not changing the configuration of this parameter.
    ...
    // Build each component's configuration based on the stored values
