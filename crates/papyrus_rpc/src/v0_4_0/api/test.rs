...
async fn get_storage_at() {
    ...
    // Set 'key' to have a different value in the pending block and the non-pending block, and test
    // the value when the pending block is updated and when it's not updated.
    pending_data
        .write()
        .await
        .state_update
