...
impl JsonRpcV0_4Server for JsonRpcServerV0_4Impl {
    ...
    async fn estimate_message_fee(
        ...
        // transaction.
        // The fee input is used by the blockifier to verify that enough fee was paid for the
        // message in L1, but because we want to estimate this fee, we pass u128::MAX so it
        ...
        match estimate_fee_result {
            Ok(Ok(fee_as_vec)) => {
                ...
                let (gas_price, fee) = fee_as_vec.first().expect("No fee was returned");
