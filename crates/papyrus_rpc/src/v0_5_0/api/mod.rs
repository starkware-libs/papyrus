...
use super::state::{ContractClass, GatewayStateUpdate};
...
use crate::v0_5_0::error::INVALID_CONTINUATION_TOKEN;
...
pub trait JsonRpc {
    ...
    fn get_transaction_status(&self, transaction_hash: TransactionHash) -> RpcResult<String>; // Temporary...
