...
#[tokio::test]
#[ignore]
// Sends a 'transfer of eth transaction from user A to user B' to a node instance.
async fn test_gw_integration_testnet() {
    ...
    // TODO(tzahi): Switch to "pending" once supported and add an assertion for the balance update
    // in the end.
    let nonce = client
