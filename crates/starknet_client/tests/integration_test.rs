...
const NODE_VERSION: &str = "PAPYRUS-INTEGRATION-TEST-STARKNET-CLIENT";
...
fn into_block_number_iter<T: Serialize>(obj: T) -> Vec<BlockNumber> {
...
async fn test_get_block(
    ...
    for block_number in into_block_number_iter(block_numbers) {
