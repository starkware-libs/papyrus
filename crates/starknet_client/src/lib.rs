...
/// Represents a [`Result`] in which the error is a [`ClientError`].
...
/// Represents error codes returned by the starknet gateway.
...
/// Represents different errors that might be encountered while creating the client.
...
/// Represents different errors that might be solved by retrying mechanism.
...
/// Represents errors that may be returned by the client.
#[derive(thiserror::Error, Debug)]
