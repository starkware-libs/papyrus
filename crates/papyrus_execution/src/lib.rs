...
fn get_config_file(file_name: &str) -> File {
...
pub struct BlockExecutionConfig {
    ...
    pub vm_resources_fee_cost: HashMap<String, f64>,
}
...
fn create_block_context(
    ...
    BlockContext {
        ...
        vm_resource_fee_cost: execution_config.vm_resources_fee_cost.clone().into(),
