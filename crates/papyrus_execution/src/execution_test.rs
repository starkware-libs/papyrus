...
fn test_default_execution_config() {
    let mut vm_resources_fee_cost = HashMap::new();
    vm_resources_fee_cost.insert("n_steps".to_owned(), 0.01);
    vm_resources_fee_cost.insert("pedersen_builtin".to_owned(), 0.32);
    vm_resources_fee_cost.insert("range_check_builtin".to_owned(), 0.16);
    vm_resources_fee_cost.insert("ecdsa_builtin".to_owned(), 20.48);
    vm_resources_fee_cost.insert("bitwise_builtin".to_owned(), 0.64);
    vm_resources_fee_cost.insert("poseidon_builtin".to_owned(), 0.32);
    vm_resources_fee_cost.insert("output_builtin".to_owned(), 1.0);
    vm_resources_fee_cost.insert("ec_op_builtin".to_owned(), 10.24);
    vm_resources_fee_cost.insert("keccak_builtin".to_owned(), 20.48);
