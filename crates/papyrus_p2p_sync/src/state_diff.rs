...
impl BlockData for (ThinStateDiff, BlockNumber) {
    #[latency_histogram("p2p_sync_state_diff_write_to_storage_latency_secodns", true)]
    fn write_to_storage(
        self: Box<Self>,
...
impl DataStreamFactory for StateDiffStreamFactory {
    ...
    #[latency_histogram("p2p_sync_state_diff_parse_data_for_block_latency_secodns", true)]
...
#[latency_histogram("p2p_sync_state_diff_unite_state_diffs_latency_secodns", true)]
...
#[latency_histogram(
    "p2p_sync_state_diff_validate_deprecated_declared_classes_non_conflicting_latency_secodns",
    true
)]
