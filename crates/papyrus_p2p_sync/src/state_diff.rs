...
impl BlockData for (ThinStateDiff, BlockNumber) {
    #[latency_histogram("p2p_sync_state_diff_write_to_storage_latency", true)]
    fn write_to_storage(
        self: Box<Self>,
...
impl DataStreamFactory for StateDiffStreamFactory {
    ...
    #[latency_histogram("p2p_sync_state_diff_parse_data_for_block_latency", true)]
...
#[latency_histogram("p2p_sync_state_diff_unite_state_diffs_latency", true)]
