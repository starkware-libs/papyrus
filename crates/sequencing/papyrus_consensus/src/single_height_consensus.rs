...
impl<BlockT: ConsensusBlock> SingleHeightConsensus<BlockT> {
    pub(crate) fn new(validators: Vec<ValidatorId>, height: BlockNumber, id: ValidatorId) -> Self {
    ...
    #[instrument(skip(self, context), fields(height=self.height.0), level = "debug")]
