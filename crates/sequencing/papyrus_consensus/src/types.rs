...
pub trait ConsensusBlock: Send {
    ...
    //    cheap.
    // TODO: Consider changing ConsensusBlock to `IntoIterator + Clone` and removing
    // `proposal_iter`.
...
pub trait ConsensusContext: Send + Sync {
    ...
    // TODO: The oneshot for receiving the build block could be generalized to just be some future
