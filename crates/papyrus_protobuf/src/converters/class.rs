...
use papyrus_common::pending_classes::{ApiContractClass, Class};
...
impl TryFrom<protobuf::Class> for Class {
    type Error = ProtobufConversionError;
    fn try_from(value: protobuf::Class) -> Result<Self, Self::Error> {
        let domain = enum_int_to_volition_domain(
            i32::try_from(value.domain).expect("Failed converting u32 to i32"),
        )?;
        ...
        Ok(Class { domain, class })
    }
}

impl From<Class> for protobuf::Class {
    fn from(value: Class) -> Self {
        let domain = volition_domain_to_enum_int(value.domain)
            .try_into()
            .expect("Failed converting i32 to u32");
        let class = match value.class {
...
impl TryFrom<protobuf::Cairo0Class> for deprecated_contract_class::ContractClass {
    ...
    fn try_from(value: protobuf::Cairo0Class) -> Result<Self, Self::Error> {
        let mut entry_points_by_type: HashMap<
            ...
            Vec<deprecated_contract_class::EntryPoint>,
        > = HashMap::new();
...
impl TryFrom<protobuf::Cairo1Class> for state::ContractClass {
    ...
    fn try_from(value: protobuf::Cairo1Class) -> Result<Self, Self::Error> {
        ...
        let mut entry_points_by_type: HashMap<state::EntryPointType, Vec<state::EntryPoint>> =
            HashMap::new();
        entry_points_by_type.insert(
