...
impl<'env, Mode: TransactionKind> HeaderStorageReader for StorageTxn<'env, Mode> {
    ...
    fn get_block_header(&self, block_number: BlockNumber) -> StorageResult<Option<BlockHeader>> {
        ...
        Ok(Some(BlockHeader {
            ...
            eth_l1_gas_price: block_header.eth_l1_gas_price,
            strk_l1_gas_price: block_header.strk_l1_gas_price,
    ...
    fn revert_header(
        ...
        Ok((
            ...
            Some(BlockHeader {
                ...
                eth_l1_gas_price: reverted_header.eth_l1_gas_price,
                strk_l1_gas_price: reverted_header.strk_l1_gas_price,
