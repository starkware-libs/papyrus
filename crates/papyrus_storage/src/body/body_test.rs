...
async fn append_body() {
    ...
    let exec_statuses = body.transaction_execution_statuses;

    let body0 = BlockBody {
        transactions: vec![txs[0].clone()],
        transaction_outputs: vec![tx_outputs[0].clone()],
        transaction_execution_statuses: vec![exec_statuses[0].clone()],
    };
    ...
    let body2 = BlockBody {
        ...
        transaction_execution_statuses: vec![exec_statuses[1].clone(), exec_statuses[2].clone()],
    };
    let body3 = BlockBody {
        transactions: vec![txs[3].clone(), txs[0].clone()],
        transaction_outputs: vec![tx_outputs[3].clone(), tx_outputs[0].clone()],
        transaction_execution_statuses: vec![exec_statuses[3].clone(), exec_statuses[0].clone()],
    };
    writer
        .begin_rw_txn()
        .unwrap()
