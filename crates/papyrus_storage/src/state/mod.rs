...
#[latency_histogram("storage_update_marker_to_next_block_latency", true)]
...
#[latency_histogram(
    "storage_advance_compiled_class_marker_over_blocks_without_classes_latency",
    true
)]
...
#[latency_histogram("storage_write_deployed_contracts_latency", true)]
...
#[latency_histogram("storage_write_nonce_latency", true)]
fn write_nonces<'env>(
...
#[latency_histogram("storage_write_replaced_classes_latency", true)]
...
#[latency_histogram("storage_write_storage_diffs_latency", true)]
