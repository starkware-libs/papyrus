...
impl<'env> StateStorageWriter for StorageTxn<'env, RW> {
    fn append_state_diff(
        ...
        debug!("2. End open table");
        update_marker(&self.txn, &markers_table, block_number)?;

        debug!("3. Deploy contract");
