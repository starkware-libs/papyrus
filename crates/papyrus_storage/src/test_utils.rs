...
/// The TempDir object is returned to as a handler for the lifetime of this object (the temp directory), thus make sure the directory won't be destroyed.
/// The caller should propagate the TempDir object until it is no longer needed.
/// When the TempDir object is dropped, the directory is deleted.
