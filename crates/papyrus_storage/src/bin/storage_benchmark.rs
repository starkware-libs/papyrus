...
fn get_cli_params() -> CliParams {
    ...
    let queries_file_path = matches
        ...
        .expect("Should be able to parse queries_file_path")
        .to_string();
    let db_file_path = matches
        .get_one::<String>("db_file_path")
        .expect("Should be able to parse db_file_path")
        .to_string();
    let output_file_path = matches
        .get_one::<String>("output_file_path")
        .expect("Should be able to parse output_file_path")
        .to_string();
    let chain_id = matches
        .get_one::<String>("chain_id")
        .expect("Should be able to parse chain_id")
        .to_string();
