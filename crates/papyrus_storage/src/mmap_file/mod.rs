...
// This serialization write the offset as 6 bytes and the length as 3 bytes.
// This means the size of the file is limit to  256TB (1<<48 bytes) and the length 16 MB (1<<24
// bytes).
