...
// This serialization writes the offset as 6 bytes and the length as 4 bytes.
// This means the size of the file is limited to  256TB (1<<48 bits) and the length of the data
// is limited to 4GB (1<<32 bits).
