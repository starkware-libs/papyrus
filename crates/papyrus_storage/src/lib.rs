...
use serialization::serializers;
use serializers::ValuePlaceHolder;
...
struct_field_names! {
    struct Tables {
        ...
        contract_storage: TableIdentifier<((ContractAddress, StorageKey), BlockNumber), NoVersionValueWrapper<StarkFelt>, CommonPrefix>,
