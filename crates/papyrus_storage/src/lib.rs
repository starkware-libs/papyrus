...
pub fn open_storage(db_config: DbConfig) -> StorageResult<(StorageReader, StorageWriter)> {
    ...
    let tables = Arc::new(Tables {
        ...
        ommer_transactions_idx_to_meta: db_writer.create_table("ommer_transactions_idx_to_meta")?,
        state_diffs: db_writer.create_table("state_diffs")?,
        transaction_hash_to_idx: db_writer.create_table("transaction_hash_to_idx")?,
        transaction_idx_to_meta: db_writer.create_table("transaction_idx_to_meta")?,
...
struct_field_names! {
    struct Tables {
        ...
        ommer_transactions_idx_to_meta: TableIdentifier<OmmerTransactionKey, (TransactionHash, TransactionExecutionStatus)>,
        ...
        transaction_idx_to_meta: TableIdentifier<TransactionIndex, (TransactionHash, TransactionExecutionStatus)>,
