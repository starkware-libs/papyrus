...
struct_field_names! {
    struct Tables {
        ...
        transaction_outputs: TableIdentifier<TransactionIndex, NoVersionValueWrapper<LocationInFile>, SimpleTable>,
...
struct FileHandlers<Mode: TransactionKind> {
    ...
    thin_transaction_output: FileHandler<NoVersionValueWrapper<ThinTransactionOutput>, Mode>,
}
