...
pub trait SerializeConfig {
    ...
    /// Takes a vector of {target pointer params, description, and vector of pointing params}, adds
    /// the target pointer params with the description and a value, and replaces the value of the
    /// pointing params to contain only the name of the target they point to.
    ///
