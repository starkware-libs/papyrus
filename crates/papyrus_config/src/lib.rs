...
/// Appends the sub config name to the beginning of each param path of the config_dump.
/// This is a util for dumping a config (sub-config) contained in another config (parent config).
/// For successful loading, the sub_config_name should be the name of this field in the parent
/// config.
