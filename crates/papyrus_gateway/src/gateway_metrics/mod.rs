...
//   - help to metrics.
//   - initial value of zero to metrics.
//   - failed requests by method and version.
// all of those can be done with a function to init the metrics using the function
// "get_methods_from_supported_apis".
