...
use starknet_api::{
    ...
    ContractAddressSalt, ContractClass, DeclareTransactionOutput, DeployTransactionOutput,
    DeployedContract, Fee, GlobalRoot, Nonce, StarkFelt, StarkHash, StateDiff, StorageDiff,
    StorageEntry, StorageKey, TransactionHash, TransactionOutput, TransactionReceipt,
    TransactionVersion,
};
...
pub fn get_test_block(transaction_count: usize) -> starknet_api::Block {
    ...
    for i in 0..transaction_count {
        let transaction = starknet_api::Transaction::Deploy(starknet_api::DeployTransaction {
