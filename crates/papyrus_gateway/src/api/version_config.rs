...
/// there can ve multiple versions that are supported (latest is implicitly supported), and there
/// can be multiple versions that are deprecated. Latest -> method exposed via the http path "/" and "" (e.g. http://host:port/)
