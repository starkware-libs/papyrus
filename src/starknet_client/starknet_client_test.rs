...
use crate::starknet_client::objects::transaction::{
    ...
    NonEmptyBuiltinInstanceCounter, TransactionIndexInBlock, TransactionReceipt,
};
    ...
    let expected_block = Block {
        ...
        transaction_receipts: vec![TransactionReceipt {
            ...
            execution_resources: ExecutionResources {
                n_steps: 5418,
                builtin_instance_counter: BuiltinInstanceCounter::NonEmpty(
                    NonEmptyBuiltinInstanceCounter {
                        bitwise_builtin: 1,
                        ec_op_builtin: 2,
                        ecdsa_builtin: 3,
                        output_builtin: 4,
