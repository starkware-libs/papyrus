...
use crate::{
    ...
    starknet_client::{objects::bytes_from_hex_str, StarknetClient},
};
...
async fn get_block_header() {
    ...
    let expected_block_header = BlockHeader {
        block_hash: BlockHash(StarkHash(
            bytes_from_hex_str("0x642b629ad8ce233b55798c83bb629a59bf0a0092f67da28d6d66776680d5483")
                .unwrap(),
        )),
        parent_hash: BlockHash(StarkHash(
            bytes_from_hex_str("0x7d74dfc2bd87ac89447a56c51abc9b6d9aca1de21cc25fd9922f3a3779ec72d")
                .unwrap(),
        )),
        gas_price: GasPrice(0x174876e800),
        number: BlockNumber(20),
        sequencer: ContractAddress(StarkHash(
            bytes_from_hex_str("0x37b2cd6baaa515f520383bee7b7094f892f4c770695fc329a8973e841a971ae")
                .unwrap(),
        )),
        timestamp: BlockTimestamp(1636991716),
        state_root: GlobalRoot(StarkHash(
            bytes_from_hex_str("07e809a2dfbe95a40ad8e5a12683e8d64c194e67a1b440027bfce23683e9fb48")
                .unwrap(),
        )),
    };
