...
use crate::starknet::StateDiffBackward;
...
pub trait StateStorageReader {
    ...
    fn get_state_diff(&self, block_number: BlockNumber) -> Result<Option<StateDiffBackward>>;
}
...
impl StateStorageWriter for BlockStorageWriter {
    fn append_state_diff(
        ...
        // Update storage and build backwards storage diff.
