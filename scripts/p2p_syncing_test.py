...
def main():
    ...
    cargo_command_1 = f"target/release/papyrus_node --base_layer.node_url {base_layer_node_url} --config_file scripts/ci_papyrus_mainnet_config_p2p_sync_receiver.json"
    cargo_command_2 = f"target/release/papyrus_node --base_layer.node_url {base_layer_node_url} --config_file scripts/ci_papyrus_mainnet_config_p2p_sync_source.json"
