...
image::https://img.shields.io/github/actions/workflow/status/starkware-libs/papyrus/ci.yml?branch=main[Github workflow status] [#LICENSE]
image::https://img.shields.io/github/license/starkware-libs/papyrus.svg?style=flat-square[Project license]
[#PRs-welcome,link=https://github.com/starkware-libs/papyrus/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22]
image::https://img.shields.io/badge/PRs-welcome-ff69b4.svg?style=flat-square[PRs welcome] [#codecov,link=https://codecov.io/gh/starkware-libs/papyrus]
image::https://codecov.io/gh/starkware-libs/papyrus/branch/main/graph/badge.svg?token=YZA9IPDHRM[codecov]
