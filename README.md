...
| Endpoint                                   | Supported          | Note        |
| :----------------------------------------- | :----------------- | :---------- |
| `starknet_addDeclareTransaction`           | :white_check_mark: | only for V4 |
| `starknet_addDeployAccountTransaction`     | :white_check_mark: | only for V4 |
| `starknet_addInvokeTransaction`            | :white_check_mark: | only for V4 |
| `starknet_blockHashAndNumber`              | :heavy_check_mark: |             |
| `starknet_blockNumber`                     | :heavy_check_mark: |             |
| `starknet_call`                            | :white_check_mark: | only for V4 |
| `starknet_chainId`                         | :heavy_check_mark: |             |
| `starknet_estimateFee`                     | :white_check_mark: | only for V4 |
